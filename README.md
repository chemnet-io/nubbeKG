...
- To Start a local development server, firstly run ```npm -i``` in the root directory
- After all npm packages are installed, run ```ws``` to start a local development server 
