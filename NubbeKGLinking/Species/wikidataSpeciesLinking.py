...
dbpedia_url = "https://query.wikidata.org/sparql"
...
def check_label_in_dbpedia(label):
    ...
    SELECT DISTINCT ?species ?speciesLabel WHERE {{
        ...
        ?species wdt:P31 wd:Q16521 .       # Überprüfe, dass es sich um eine Instanz von "Art" (Q16521) handelt
        ?species rdfs:label ?speciesLabel .
...
if nubbe_data:
    ...
    with open('NubbeKGLinking/Species/merged_species_uris_wikidata.json', 'w') as f:
